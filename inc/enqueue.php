...
function global_css()
{
    ...
    wp_register_style('min-css', get_stylesheet_directory_uri() .'/dist/main.min.css', array('parent-style'));
...
function global_js()
{
    ...
    wp_register_script('min-js', get_stylesheet_directory_uri() . '/dist/main.min.js', array('jquery'), '', true);
